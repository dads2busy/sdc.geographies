  ...
  dataset_pths <- list(
    ...
    ds_src_prepare  = list(
      ...
      dsc = paste0("# dataset creation code - dataset preparation (transformation, new variables, linkage, etc)",
                   ...
                   "\n", data_file_basename, " <- sf::st_read(\"", file.path("data", data_source_subject_abbrv, "original", paste0(data_file_basename, ".geojson\"")), ")",
                   ...
                   "\nsf::st_write(final_data_set, \"", file.path("data", data_source_subject_abbrv, "distribution", paste0(data_file_basename, ".geojson\"")), ")"
                   )
    )
  )
