...
ncr_geo_census_cb_2020_census_tracts <- us_geo_census_cb_2020_census_tracts[substr(us_geo_census_cb_2020_census_tracts$geoid, 1, 5) %in% ncr_geoids,]
...
sf::st_write(ncr_geo_census_cb_2020_census_tracts, "data/ncr_geo_census_cb_2020_census_tracts/distribution/ncr_geo_census_cb_2020_census_tracts.geojson")
