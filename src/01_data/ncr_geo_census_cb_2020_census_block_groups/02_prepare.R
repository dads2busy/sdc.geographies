...
md_geo_census_cb_2020_census_block_groups <- sf::st_read("data/ncr_geo_census_cb_2020_census_block_groups/original/md_geo_census_cb_2020_census_block_groups.geojson")
dc_geo_census_cb_2020_census_block_groups <- sf::st_read("data/ncr_geo_census_cb_2020_census_block_groups/original/dc_geo_census_cb_2020_census_block_groups.geojson")
va_geo_census_cb_2020_census_block_groups <- sf::st_read("data/ncr_geo_census_cb_2020_census_block_groups/original/va_geo_census_cb_2020_census_block_groups.geojson")
...
sf::st_write(ncr_geo_census_cb_2020_census_block_groups, "data/ncr_geo_census_cb_2020_census_block_groups/distribution/ncr_geo_census_cb_2020_census_block_groups.geojson")
