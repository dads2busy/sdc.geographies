...
us_geo_census_cb_2010_counties <- sf::st_read("data/dc_geo_census_cb_2010_counties/original/us_geo_census_cb_2010_counties.geojson")
...
sf::st_write(dc_geo_census_cb_2010_counties, "data/dc_geo_census_cb_2010_counties/distribution/dc_geo_census_cb_2010_counties.geojson")
