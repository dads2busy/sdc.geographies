...
unzip("data/md_geo_census_cb_2020_census_block_groups/original/md_geo_census_cb_2020_census_block_groups.zip", exdir = "data/md_geo_census_cb_2020_census_block_groups/original/md_geo_census_cb_2020_census_block_groups")
md_geo_census_cb_2020_census_block_groups <- sf::st_read("data/md_geo_census_cb_2020_census_block_groups/original/md_geo_census_cb_2020_census_block_groups/cb_2020_24_bg_500k.shp")
md_geo_census_cb_2020_census_block_groups <- sf::st_transform(md_geo_census_cb_2020_census_block_groups, 4326)

unlink("data/md_geo_census_cb_2020_census_block_groups/original/md_geo_census_cb_2020_census_block_groups", recursive = T)
...
# Assign region_name
md_geo_census_cb_2020_census_tracts <- sf::st_read("data/md_geo_census_cb_2020_census_tracts/distribution/md_geo_census_cb_2020_census_tracts.geojson")
...
sf::st_write(final_dataset_simplified, "data/md_geo_census_cb_2020_census_block_groups/distribution/md_geo_census_cb_2020_census_block_groups.geojson")
